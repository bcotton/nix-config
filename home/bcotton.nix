{
  ...
  # Pinned to specific commit for reproducibility (2025-03-08)
  nixVsCodeServer = builtins.fetchTarball {
    url = "https://github.com/zeyugao/nixos-vscode-server/archive/7943271335904017d3fafbf6fea395beebe42239.tar.gz";
